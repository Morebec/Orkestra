...
namespace Morebec\Orkestra\ProjectGeneration\Domain\Model\Entity\Project;

use Assert\Assertion;
use Morebec\Orkestra\ProjectGeneration\Domain\Exception\ModuleNotFoundException;

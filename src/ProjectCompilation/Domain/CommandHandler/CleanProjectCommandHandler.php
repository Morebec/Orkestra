...
class CleanProjectCommandHandler implements MessageHandlerInterface
{
    /**
     * @var ProjectCompiler
     */
    ...
    public function __invoke(CleanProjectCommand $command)
    {
        ...
        $this->projectCompiler->cleanProject($project);
    }
}
